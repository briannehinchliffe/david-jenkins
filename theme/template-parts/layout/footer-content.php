	...
	<div class="mx-auto max-w-content px-5 py-12 lg:px-10">
		<div class="grid gap-10 md:grid-cols-3">
			...
			<div>
				...
				<div class="mt-6"><a class="inline-block rounded bg-accent px-5 py-2.5 text-sm font-semibold tracking-wide text-white transition-colors hover:bg-red-700" href="<?php echo esc_url( home_url( '/donate/' ) ); ?>"><?php esc_html_e( 'Donate Now', 'david-jenkins' ); ?></a></div>
			</div>
		</div>
		<div class="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/15 pt-6 md:flex-row">
			...
			<p class="text-xs text-blue-400"><?php esc_html_e( 'Democrat · Cheshire County, New Hampshire', 'david-jenkins' ); ?></p>
		</div>
	</div>
</footer><!-- #colophon -->
