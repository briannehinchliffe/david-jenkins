		...
		<div class="grid md:grid-cols-3 gap-10">
			...
			<div>
				...
				<div class="space-y-3">
					...
					<div class="flex items-center gap-2 text-blue-200 text-sm"><svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin text-blue-400 flex-shrink-0"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"></path><circle cx="12" cy="10" r="3"></circle></svg><span><?php esc_html_e( 'Cheshire County, New Hampshire', 'david-jenkins' ); ?></span></div>
				</div>
