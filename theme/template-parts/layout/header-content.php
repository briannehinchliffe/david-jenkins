	...
	<div class="max-w-content mx-auto px-5 lg:px-10">
		<div class="flex items-center justify-between h-20 lg:h-30">
			...
			<?php if ( has_nav_menu( 'menu-1' ) ) : ?>
				...
				<button id="menu-toggle" class="lg:hidden text-primary p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-white" aria-expanded="false" aria-controls="mobile-menu" aria-label="Toggle menu">
